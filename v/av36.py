...
def _http_get(url, timeout=15):
    ...
    try:
        ...
        return ''
_CATS = [
    (1, '日韩无码', 54), (2, '国产主播', 55),(55, '网红主播', 108), (42, '学生空姐', 95), 
    (58, '抖阴直播', 111),(6, '自拍偷拍', 60),(41, '百合女同', 94),  (12, '自慰系列', 73), 
    (9, '巨乳尤物', 70), (10, '颜射系列', 71), (11, '口交视频', 72),(7, '伦理影片', 61),
 ...
 (43, '撸管必看', 96), (44, '偷情少妇', 97),(77, '主播热舞', 130), (8, '视频二区', 69),
    (45, '萝莉幼齿', 98), (46, '嫩模大秀', 99), (47, '原味内衣', 100), (48, '视频六区', 101),
    (49, '韩系主播', 102), (50, '情侣自拍', 103), (51, '美腿丝袜', 104), (52, '超碰在线', 105),
    (53, '福利导航', 106), (54, '视频七区', 107), (56, '足控专区', 109),(4, '欧美劲爆', 58),
    (57, '视频八区', 110),  (59, '九色视频', 112), (60, '香蕉视频', 113), (5, '成人动漫', 59), 
