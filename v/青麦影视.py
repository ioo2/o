...
class Spider(B):
 ...
 def detailContent(self,ids):
  ...
  if l:o["vod_play_from"]="恒轩";o["vod_play_url"]="#".join(["%s$%s@@%s@@%s"%((x.get("episode")or"第%s集"%x.get("episodeNum","?")),t,m,x.get("id",""))for x in l])
  else:o["vod_play_from"]="恒轩";o["vod_play_url"]="正片$%s@@%s@@"%(t,m)
  return{"list":[o]}
